...
class OpsTest(parameterized.TestCase):
    ...
    def testGroupedGemm_FixedSizes(self, z, m, k, n, trans_b, batch_sizes_on_device):
        ...
        out = ops.gmm_CUTLASS_sm90_pingpong(a, b, batch_sizes, trans_b=trans_b)
...
class EdgeCasesTest(unittest.TestCase):
    ...
    def testGroupedGemm_ZeroSize(self, batch_sizes_on_device=False):
        ...
        out = ops.gmm_CUTLASS_sm90_pingpong(a, b, batch_sizes)
    ...
    def testGroupedGemm_ZeroK(self, batch_sizes_on_device=False):
        ...
        ops.backend.gmm_CUTLASS_sm90_pingpong(a, b, batch_sizes, trans_a=True, c=c)
